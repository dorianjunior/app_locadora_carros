<template>
  <div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between mb-10 gap-6 pb-6 border-b-2 border-primary-100 dark:border-primary-900/30">
      <div>
        <h1 class="text-display-sm font-display font-bold text-earth-900 dark:text-white mb-2">Modelos</h1>
        <p class="text-lg text-sage-600 dark:text-gray-400 font-medium">Gerencie os modelos de veículos</p>
      </div>
